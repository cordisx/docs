...
const translations = {
  en: {
    ...
    hostKicker: 'HOST / CORDISX',
    hostTitle: 'CordisX host guide',
    hostDescription: 'Architecture, extension surfaces, and the local Codex Desktop host.',
    protocolKicker: 'CONTRACT / PROTOCOL',
    protocolTitle: 'Extension protocol',
    protocolDescription: 'Versioned contracts, schemas, compatibility, and implementation guidance.',
    catalogKicker: 'DISCOVERY / MARKETPLACE',
    catalogTitle: 'Community catalog',
    catalogDescription: 'Browse public plugin metadata from the marketplace feed.',
    registryKicker: 'AGGREGATION / SOURCES',
    registryTitle: 'Documentation registry',
    registryDescription: 'See which source repositories are allowed into this documentation site.',
  ...
  'zh-CN': {
    ...
    hostKicker: 'HOST / CORDISX',
    hostTitle: 'CordisX Host 指南',
    hostDescription: '了解架构、扩展界面以及本地 Codex Desktop Host。',
    protocolKicker: '契约 / 协议',
    protocolTitle: '扩展协议',
    protocolDescription: '查看版本化契约、Schema、兼容性和实现指南。',
    catalogKicker: '发现 / 插件市场',
    catalogTitle: '社区目录',
    catalogDescription: '浏览插件市场公开数据源中的插件元数据。',
    registryKicker: '聚合 / 来源',
    registryTitle: '文档来源登记',
    registryDescription: '查看允许进入本站的文档来源仓库。',
